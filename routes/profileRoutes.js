...
const { getProfile, updateMentorProfile, addAvailabilitySlot, updateAvailabilitySlot, deleteAvailabilitySlot, initiateEmailChange, verifyCurrentEmailOTP, setNewEmail, verifyNewEmailOTP, changePassword } = require('../controllers/profileController');
